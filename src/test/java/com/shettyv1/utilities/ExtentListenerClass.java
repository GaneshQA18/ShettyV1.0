...
public class ExtentListenerClass implements ITestListener {
	...
	public void configureReport()
	{
		...
		String reportName = "ShettyV1TestReport-" + timestamp + ".html";
		...
		//cross browsing testing -make browser dynamic and same will show in extenet report
	...
	//Add Screenshot failure code in report
